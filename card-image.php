<section>
	<div class="sm:container sm:mx-auto">
		<div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
			...
			<div class="relative overflow-hidden">
			  <a class=" block bg-center rounded group" href="">
				<img class=" scale-100 group-hover:scale-125   duration-500 rounded " src="images/demo/poster-02.png" alt="project01">
				<div class="inset-0 inset-y-1/4 w-2/4 top-50 bottom-50 absolute my-auto pl-7">
					<p class="text-slate-400 group-hover:text-white mb-3  duration-500">50% Offers in Winter</p>
					<p class="text-4xl font-semibold text-white mb-2">Get VR reality Glases</p>
				</div>
			  </a>
			</div>
		</div>
