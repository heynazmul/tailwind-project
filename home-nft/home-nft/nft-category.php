			...
			<div class="splide__list h-36">
				<div class="splide__slide border m-4 ">
				  <div class="flex justify-center flex-col py-5 items-center">
					<img class="h-12" src="<?php echo $baseurl;?>images/demo/cat-11.png" alt="" />
					<div class="mt-2">
						<h4 class="text-sm font-bold">Music</h4>
					</div>
				  </div>
				</div>
				<div class="splide__slide border m-4 ">
				  <div class="flex justify-center flex-col py-5 items-center">
					<img class="h-12" src="<?php echo $baseurl;?>images/demo/category-2.png" alt="" />
					<div class="mt-2">
						<h4 class="text-sm font-bold">Music</h4>
					</div>
				  </div>
				...
				<div class="splide__slide border m-4 ">
				  <div class="flex justify-center flex-col py-5 items-center">
					<img class="h-12" src="<?php echo $baseurl;?>images/demo/category-3.png" alt="" />
					<div class="mt-2">
						<h4 class="text-sm font-bold">Music</h4>
					</div>
				  </div>
				...
				<div class="splide__slide border m-4 ">
				  <div class="flex justify-center flex-col py-5 items-center">
					<img class="h-12" src="<?php echo $baseurl;?>images/demo/category-4.png" alt="" />
					<div class="mt-2">
						<h4 class="text-sm font-bold">Music</h4>
					</div>
				  </div>
				...
				<div class="splide__slide border m-4 ">
				  <div class="flex justify-center flex-col py-5 items-center">
					<img class="h-12" src="<?php echo $baseurl;?>images/demo/category-5.png" alt="" />
					<div class="mt-2">
						<h4 class="text-sm font-bold">Music</h4>
					</div>
				  </div>
